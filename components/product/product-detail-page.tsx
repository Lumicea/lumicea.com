...
export function ProductDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Breadcrumb */}
      <div className="lumicea-container py-4">
        <Breadcrumb>
          <BreadcrumbList>
            <BreadcrumbItem>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="/categories/nose-rings">{mockProduct.category}</BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator />
            <BreadcrumbItem>
      ...
      <div className="lumicea-container pb-12">
