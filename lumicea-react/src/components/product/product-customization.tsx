...
}, [selectedMaterial, selectedGemstone, selectedSize, quantity, calculateTotalPrice, onPriceChange, onVariantChange]);
// Added calculateTotalPrice to the dependency array
