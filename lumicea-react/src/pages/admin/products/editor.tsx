...
          setProduct({ ...data, variants: data.variants || [] } as Product);
...
    if (!product) return;
    ...
    const { variants, ...productData } = product; // Exclude variants from the main product data
    const newProduct = {
      ...productData,
      id: uuidv4(),
...
    }
    ...
    const { variants, ...payload } = product;
