      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white max-w-6xl mx-auto px-4 pt-32">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
            <Button size="lg" className="lumicea-button-primary text-lg px-12 py-4 group shadow-2xl" asChild>
      ...
      <section className="py-24 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
        <div className="container mx-auto px-4 relative">
          ...
          <div className="text-center mt-12">
            <Button asChild size="lg" className="lumicea-button-primary shadow-xl">
              <Link to="/collections">
      ...
      <section className="py-24 bg-white relative">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mt-16">
            <Button size="lg" variant="outline" className="lumicea-button-secondary shadow-lg" asChild>
              <Link to="/categories/nose-rings">
                View All Products
                <ArrowRight className="ml-3 h-5 w-5" />
              </Link>
